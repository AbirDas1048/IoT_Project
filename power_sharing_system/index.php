...
<div class="tab-content" id="myTabContent">
  ...
  <div class="tab-pane fade show active text-center " id="makerequest" role="tabpanel" aria-labelledby="makerequest-tab">
      <button type="button" class="btn btn-primary" id="sell" data-toggle="modal" data-target="#SellModal">Make Request for Sell</button>
      <button type="button" class="btn btn-success" id ="bye" data-toggle="modal" data-target="#BuyModal">Make Request for Buy</button>
